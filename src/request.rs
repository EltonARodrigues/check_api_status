// use utils::yarn::{ConfigMethod, Depends, ReqHash, Request};

use reqwest::{Client, header::HeaderMap, header::HeaderName, Method, Response, Url};
...
// pub mod requests {
    ...
    pub async fn get_depends_result(depends: &Depends) -> HashMap<String, Vec<ReqHash>> {
